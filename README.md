...
| 1872 | [Stone Game VIII](https://leetcode.com/problems/stone-game-viii/) | Dynamic Programming, Game Theory, Prefix Sum | Hard | O(n) | O(n) | [C++](./1001-2000/1872_Stone_Game_VIII.cpp) |
...
| 2904 | [Shortest and Lexicographically Smallest Beautiful String](https://leetcode.com/problems/shortest-and-lexicographically-smallest-beautiful-string/) | String, Sliding Window, Two Pointers | Medium | O(n²) | O(n) | [C++](./2001-3000/2904_Shortest_and_Lexicographically_Smallest_Beautiful_String.cpp) |
...
| 3302 | [Find the Lexicographically Smallest Valid Sequence](https://leetcode.com/problems/find-the-lexicographically-smallest-valid-sequence/) | Two Pointers, String, Greedy | Medium | O(n + m) | O(m) | [C++](./3001-4000/3302_Find_the_Lexicographically_Smallest_Valid_Sequence.cpp) |
...
| 3718 | [Smallest Missing Multiple of K](https://leetcode.com/problems/smallest-missing-multiple-of-k/) | Array, Hash Table, Math | Easy | O(n) | O(n) | [C++](./3001-4000/3718_Smallest_Missing_Multiple_of_K.cpp) |
